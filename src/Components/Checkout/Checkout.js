...
const Checkout = () => {
  ...
  const calculateShippingFee = (cartItems) => {
    ...
    if (totalQuantity === 1) return 50;
    if (totalQuantity === 2) return 70;
    return 99;
  };
  ...
  return (
    <section className="min-vh-100 checkout" style={{ backgroundColor: "#eee" }}>
          ...
          <div className="card-body p-4">
              ...
              <div className="col-lg-7">
                ...
                <div className="d-flex justify-content-between align-items-center mb-4">
                  <div>
                    ...
                    <p className="mb-0">You have <strong>{totalQuantity}</strong>  items in your cart</p>
                  </div>
                </div>
                {filterCart?.map((item) => (
           ...
           <div className="">
             ...
             <div className="d-flex justify-content-between">
                      ...
                      <p className="mb-2">&pound;{subtotal?.toFixed()}.00</p>
                    </div>
                    <div className="d-flex justify-content-between">
                    ...
                    <div className="d-flex justify-content-between mb-4">
                      ...
                      <p className="mb-2">&pound;{total?.toFixed()}.00</p>
                    </div>
               ...
               />
                    ...
                    >
                      <div className="d-flex justify-content-between">
                        <span>&pound;{total?.toFixed()}.00 &nbsp;</span>
                        <span>
                          Checkout{" "}
                        </span>
                      </div>
