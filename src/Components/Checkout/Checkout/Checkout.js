  ...
  return (
    <div>
      {loading ? (
        ...
        <section className="min-vh-100 checkout">
                          ...
                          <div className="row py-3">
                            ...
                            <div className="col-md-6 mb-3">
                              <input
                                ...
                                className="form-control py-2 border text-dark"
                                ...
                                >
                                  ...
                                  >
                                    <input
                                      ...
                                      defaultChecked
                                      value="Pay with Credit Card/Debit Card"
                                    />
                                    <p
                                      style={{
                                        color: "white",
                      ...
                      <div className="col-lg-4 col-md-6 col-sm-12 px-4 pt-5 pt-lg-3">
                        ...
                        {filterCart?.map((item, index) => {
                          return (
                            <>
                              <div
                                className="row border-0 border-bottom border-light shadow-sm mb-1 py-3 chk_Card"
                                key={index}
                        ...
                        <div
                          className="row mt-3 py-3 border text-dark"
                        ...
                        <a href="/Products/all">
                          <button className="button-submit px-4 w-100">
                            Continue Shopping
                          </button>
                        </a>
                      </div>
